...
struct Process {
	...
	int startTime, completionTime, arrivalTime, waitTime, turnaroundTime;
};

void printTime(Process*, int, int);
void printQueue(vector<int>);
void printMap(Process, int, vector<int>, vector<int>&, int);
...
int main() {
	...
	cout << "\nAverage Turn Around Time: " << averageTurnaround << endl;
